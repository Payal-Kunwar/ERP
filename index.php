...
<div class="footer">
	<div class="container">
		...
		<div class="container">
				...
				<div class="clearfix"> </div>
				<p class="footer-class animated wow fadeInUp animated" data-wow-delay=".5s" style="visibility: visible; animation-delay: 0.5s; animation-name: fadeInUp;"> © 2022 Youth Fashion . All Rights Reserved | Maintained by <a href="#" target="_blank">PAYS</a> </p>
			</div>
	</div>
</div>
<!--footer-->
